...
const (
	...
	MethodSessionsGroupsDefaults             = "sessions.groups.defaults"
	MethodSessionsGroupsUpdate               = "sessions.groups.update"
	...
	MethodTasksDismiss                       = "tasks.dismiss"
	...
	MethodDevicePairSetupCode         = "device.pair.setupCode"
	MethodDevicePairSetupStatus       = "device.pair.setupStatus"
	MethodDeviceTokenRotate           = "device.token.rotate"
	MethodDeviceTokenRevoke           = "device.token.revoke"
	MethodDeviceScopesRequestUpgrade  = "device.scopes.requestUpgrade"
	MethodDeviceScopesWaitUpgrade     = "device.scopes.waitUpgrade"
	MethodNodeList                    = "node.list"
	MethodNodeDescribe                = "node.describe"
	MethodNodeRename                  = "node.rename"
	MethodNodeInvoke                  = "node.invoke"
	MethodNodeRunnerInventoryUpdate   = "node.runnerInventory.update"
	...
	MethodExecApprovalGrantsList   = "exec.approval.grants.list"
	MethodExecApprovalGrantsRevoke = "exec.approval.grants.revoke"
