...
type ServerOptions struct {
	...
	NodePairRemove              func(context.Context, methods.NodePairRemoveRequest) (map[string]any, error)
	...
	DevicePairRename            func(context.Context, methods.DevicePairRenameRequest) (map[string]any, error)
	...
	NodeInvokeProgress          func(context.Context, methods.NodeInvokeProgressRequest) (map[string]any, error)
	...
	CronGet                     func(context.Context, methods.CronJobSelectorRequest) (map[string]any, error)
	...
	CronScratchGet              func(context.Context, methods.CronJobSelectorRequest) (map[string]any, error)
	CronScratchSet              func(context.Context, methods.CronScratchSetRequest) (map[string]any, error)
