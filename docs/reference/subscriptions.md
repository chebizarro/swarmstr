...
| `30315` | NIP-38 (`KindNIP38Status`) | Write | User status / log status |
| `30316` | Cascadia (`CAS_AGENT_HEARTBEAT`) | Write | Agent lifecycle heartbeat |
| `30317` | Cascadia (`CAS_AGENT_CAPABILITY`) | Read/Write | Capability descriptor and fleet discovery |
